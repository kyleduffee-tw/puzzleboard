...
function renderUser() {
  ...
  if (S.myName) {
    ...
    myBanner.innerHTML = `<div class="my-banner" style="flex-wrap:wrap;cursor:pointer;" onclick="toggleBannerDrawer()">
      ...
      <div id="banner-drawer" style="display:none;width:100%;flex-basis:100%;margin-top:14px;padding-top:14px;border-top:1px solid rgba(124,108,255,0.3);">
