...
function renderUser() {
  ...
  if (ranked.length===0 || ranked.every(p=>p.total===0)) {
    ...
    if (!_storageReady) {
      ...
      emptyHTML = `<div class="empty-state"><img src="mascot_sad.png" alt="" style="width:64px;height:auto;margin-bottom:8px;"><div class="empty-title">Board not loaded</div><div class="empty-sub">Could not reach the server. Click ↻ to try syncing again.</div></div>`;
